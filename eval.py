...
def main():
    ...
    agent = Agent(obs_size, 10, nb_actions, 0.95, 1.0, 0.995, 0.01, 0.001, 1000, stock_name=stock, episode=episode, is_eval=True)
    env = MarketEnv(stock, window_size=10 ,is_eval=True, train_test_split=.8)
